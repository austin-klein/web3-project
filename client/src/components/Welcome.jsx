...
const Welcome = () => {
  const { connectWallet, currentAccount, sendTransaction, formData, handleChange, isLoading } =
    ...
    <div className='flex w-full justify-center items-center'>
      <div className='flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4'>
        <div className='flex flex-1 justify-start flex-col mf:mr-10'>
          ...
          {!currentAccount && (
            <button
              className='flex flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd] text-white text-base font-bold'
              type='button'
          ...
          <div className='grid sm:grid-cols-3 grid-cols-2 w-full mt-10'>
            ...
            <div className={`sm:rounded-br-2xl ${commonStyles}`}>Blockchain</div>
          </div>
        </div>
